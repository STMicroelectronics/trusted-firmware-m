...
#define DT_MBOX_CTLR_BY_IDX(node_id, idx) \
	DT_PHANDLE_BY_IDX(node_id, mboxes, idx)
...
#define DT_MBOX_CHANNEL_BY_NAME(node_id, name) \
	DT_PHA_BY_NAME(node_id, mboxes, name, channel)

#define DT_MBOX_CHANNEL_BY_IDX(node_id, idx) \
	DT_PHA_BY_IDX(node_id, mboxes, idx, channel)
