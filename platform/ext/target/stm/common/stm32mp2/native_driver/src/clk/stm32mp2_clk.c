...
static const struct div_cfg dividers_mp25[LAST_DIV] = {
	DIV_CFG(DIV_APB1DIV, RCC_APB1DIVR, 0, 3, 0, apb_div_table, 31),
	DIV_CFG(DIV_APB2DIV, RCC_APB3DIVR, 0, 3, 0, apb_div_table, 31),
	DIV_CFG(DIV_APB3DIV, RCC_APB3DIVR, 0, 3, 0, apb_div_table, 31),
	DIV_CFG(DIV_APB4DIV, RCC_APB4DIVR, 0, 3, 0, apb_div_table, 31),
...
static const struct clk_pll stm32mp25_clk_pll[_PLL_NB] = {
	_CLK_PLL(_PLL1, RCC_MUXSELCFGR_MUXSEL5_SHIFT, 0),
	_CLK_PLL(_PLL2, RCC_MUXSELCFGR_MUXSEL6_SHIFT, RCC_PLL2CFGR1),
	_CLK_PLL(_PLL3, RCC_MUXSELCFGR_MUXSEL7_SHIFT, RCC_PLL3CFGR1),
	_CLK_PLL(_PLL4, RCC_MUXSELCFGR_MUXSEL0_SHIFT, RCC_PLL4CFGR1),
	_CLK_PLL(_PLL5, RCC_MUXSELCFGR_MUXSEL1_SHIFT, RCC_PLL5CFGR1),
	_CLK_PLL(_PLL6, RCC_MUXSELCFGR_MUXSEL2_SHIFT, RCC_PLL6CFGR1),
	_CLK_PLL(_PLL7, RCC_MUXSELCFGR_MUXSEL3_SHIFT, RCC_PLL7CFGR1),
	_CLK_PLL(_PLL8, RCC_MUXSELCFGR_MUXSEL4_SHIFT, RCC_PLL8CFGR1),
};

/* PLL configuration registers offsets from RCC_PLLxCFGR1 */
static const uintptr_t pll_cfgr_offsets[] = {
	0x00, /* RCC_PLLxCFGR1 offset */
	0x04, /* RCC_PLLxCFGR2 offset */
	0x08, /* RCC_PLLxCFGR3 offset */
	0x0C, /* RCC_PLLxCFGR4 offset */
	0x10, /* RCC_PLLxCFGR5 offset */
	0x18, /* RCC_PLLxCFGR6 offset */
	0x1C, /* RCC_PLLxCFGR7 offset */
};
					...
					unsigned long prate)
{
	...
	prediv = mmio_read_32(rcc_base + RCC_PREDIV0CFGR + (0x4 * channel)) &
		RCC_PREDIVxCFGR_PREDIVx_MASK;
	findiv = mmio_read_32(rcc_base + RCC_FINDIV0CFGR + (0x4 * channel)) &
...
static int clk_flexgen_gate_enable(struct stm32_clk_priv *priv, int idx)
{
	...
	mmio_setbits_32(rcc_base + RCC_FINDIV0CFGR + (0x4 * channel),
...
static void clk_flexgen_gate_disable(struct stm32_clk_priv *priv, int id)
{
	...
	mmio_clrbits_32(rcc_base + RCC_FINDIV0CFGR + (0x4 * channel),
			RCC_FINDIVxCFGR_FINDIVxEN);
...
static bool clk_flexgen_gate_is_enabled(struct stm32_clk_priv *priv, int id)
{
	...
	return !!(mmio_read_32(rcc_base + RCC_FINDIV0CFGR + (0x4 * channel)) &
		RCC_FINDIVxCFGR_FINDIVxEN);
}
...
static const struct clk_stm32 stm32mp25_clk[CK_LAST] = {
	...
	CK_TIMER(_TIMG1_CK, TIMG1_CK, _CK_ICN_APB1, 0,
		 RCC_APB1DIVR, RCC_TIMG1PRER),
	CK_TIMER(_TIMG2_CK, TIMG2_CK, _CK_ICN_APB2, 0,
		 RCC_APB2DIVR, RCC_TIMG2PRER),

	/* KERNEL CLOCK */
	GATE(_CK_SYSRAM, CK_BUS_SYSRAM, _CK_ICN_HS_MCU, 0, RCC_SYSRAMCFGR, 1),
	GATE(_CK_VDERAM, CK_BUS_VDERAM, _CK_ICN_HS_MCU, 0, RCC_VDERAMCFGR, 1),
	...
	GATE(_CK_HPDMA1, CK_BUS_HPDMA1, _CK_ICN_LS_MCU, 0, RCC_HPDMA1CFGR, 1),
	GATE(_CK_HPDMA2, CK_BUS_HPDMA2, _CK_ICN_LS_MCU, 0, RCC_HPDMA2CFGR, 1),
	GATE(_CK_HPDMA3, CK_BUS_HPDMA3, _CK_ICN_LS_MCU, 0, RCC_HPDMA3CFGR, 1),

	// GATE(_CK_ADC12, CK_BUS_ADC12, _CK_ICN_LS_MCU, 0, RCC_ADC12CFGR, 1),
	// GATE(_CK_ADC3, CK_BUS_ADC3, _CK_ICN_LS_MCU, 0, RCC_ADC3CFGR, 1),
	GATE(_CK_IPCC1, CK_BUS_IPCC1, _CK_ICN_LS_MCU, 0, RCC_IPCC1CFGR, 1),
	GATE(_CK_CCI, CK_BUS_CCI, _CK_ICN_LS_MCU, 0, RCC_CCICFGR, 1),
	...
	GATE(_CK_LPSRAM1, CK_BUS_LPSRAM1, _CK_ICN_LS_MCU, 0, RCC_LPSRAM1CFGR, 1),
	GATE(_CK_LPSRAM2, CK_BUS_LPSRAM2, _CK_ICN_LS_MCU, 0, RCC_LPSRAM2CFGR, 1),
	GATE(_CK_LPSRAM3, CK_BUS_LPSRAM3, _CK_ICN_LS_MCU, 0, RCC_LPSRAM3CFGR, 1),

	GATE(_CK_GPU, CK_BUS_GPU, _CK_FLEXGEN_59, 0, RCC_GPUCFGR, 1),
	GATE(_CK_PCIE, CK_BUS_PCIE, _CK_ICN_HSL, 0, RCC_PCIECFGR, 1),

	GATE(_CK_GPIOZ, CK_BUS_GPIOZ, _CK_ICN_LS_MCU, 0, RCC_GPIOZCFGR, 1),
	GATE(_CK_LPDMA, CK_BUS_LPDMA, _CK_ICN_LS_MCU, 0, RCC_LPDMACFGR, 1),
	GATE(_CK_HSEM, CK_BUS_HSEM, _CK_ICN_LS_MCU, 0, RCC_HSEMCFGR, 1),
	GATE(_CK_IPCC2, CK_BUS_IPCC2, _CK_ICN_LS_MCU, 0, RCC_IPCC2CFGR, 1),
	GATE(_CK_RTC, CK_BUS_RTC, _CK_ICN_LS_MCU, 0, RCC_RTCCFGR, 1),
	GATE(_CK_IWDG5, CK_BUS_IWDG5, _CK_ICN_LS_MCU, 0, RCC_IWDG5CFGR, 1),
	GATE(_CK_WWDG2, CK_BUS_WWDG2, _CK_ICN_LS_MCU, 0, RCC_WWDG2CFGR, 1),

	GATE(_CK_DDRCP, CK_BUS_DDR1, _CK_ICN_DDR, 0, RCC_DDRCPCFGR, 1),

	GATE(_CK_LTDC, CK_BUS_LTDC, _CK_ICN_DISPLAY, 0, RCC_LTDCCFGR, 1),
	GATE(_CK_DCMIPP, CK_BUS_DCMIPP, _CK_ICN_DISPLAY, 0, RCC_DCMIPPCFGR, 1),
	...
	GATE(_CK_IWDG3, CK_BUS_IWDG3, _CK_ICN_APB3, 0, RCC_IWDG3CFGR, 1),
	GATE(_CK_IWDG4, CK_BUS_IWDG4, _CK_ICN_APB3, 0, RCC_IWDG4CFGR, 1),
	GATE(_CK_WWDG1, CK_BUS_WWDG1, _CK_ICN_APB3, 0, RCC_WWDG1CFGR, 1),
	GATE(_CK_VREF, CK_BUS_VREF, _CK_ICN_APB3, 0, RCC_VREFCFGR, 1),
	GATE(_CK_TMPSENS, CK_BUS_TMPSENS, _CK_ICN_APB3, 0, RCC_TMPSENSCFGR, 1),
	GATE(_CK_SERC, CK_BUS_SERC, _CK_ICN_APB3, 0, RCC_SERCCFGR, 1),
	GATE(_CK_HDP, CK_BUS_HDP, _CK_ICN_APB3, 0, RCC_HDPCFGR, 1),
	GATE(_CK_IS2M, CK_BUS_IS2M, _CK_ICN_APB3, 0, RCC_IS2MCFGR, 1),

	GATE(_CK_DDRCAPB, CK_BUS_DDRC, _CK_ICN_APB4, 0, RCC_DDRCAPBCFGR, 1),
	GATE(_CK_DDR, CK_BUS_DDRCFG, _CK_ICN_APB4, 0, RCC_DDRCFGR, 1),
	GATE(_CK_GICV2M, CK_BUS_GICV2M, _CK_ICN_APB4, 0, RCC_GICV2MCFGR, 1),
	GATE(_CK_BUSPERFM, CK_BUS_BUSPERFM, _CK_ICN_APB4, 0, RCC_BUSPERFMCFGR, 1),
	GATE(_CK_STM500, CK_BUS_STM500, _CK_ICN_APBDBG, 0, RCC_STM500CFGR, 1),

	GATE(_CK_VDEC, CK_BUS_VDEC, _CK_ICN_VID, 0, RCC_VDECCFGR, 1),
	GATE(_CK_VENC, CK_BUS_VENC, _CK_ICN_VID, 0, RCC_VENCCFGR, 1),

	GATE(_CK_TIM2, CK_KER_TIM2, _TIMG1_CK, 0, RCC_TIM2CFGR, 1),
	GATE(_CK_TIM3, CK_KER_TIM3, _TIMG1_CK, 0, RCC_TIM3CFGR, 1),
	GATE(_CK_TIM4, CK_KER_TIM4, _TIMG1_CK, 0, RCC_TIM4CFGR, 1),
	GATE(_CK_TIM5, CK_KER_TIM5, _TIMG1_CK, 0, RCC_TIM5CFGR, 1),
	GATE(_CK_TIM6, CK_KER_TIM6, _TIMG1_CK, 0, RCC_TIM6CFGR, 1),
	GATE(_CK_TIM7, CK_KER_TIM7, _TIMG1_CK, 0, RCC_TIM7CFGR, 1),
	GATE(_CK_TIM10, CK_KER_TIM10, _TIMG1_CK, 0, RCC_TIM10CFGR, 1),
	GATE(_CK_TIM11, CK_KER_TIM11, _TIMG1_CK, 0, RCC_TIM11CFGR, 1),
	GATE(_CK_TIM12, CK_KER_TIM12, _TIMG1_CK, 0, RCC_TIM12CFGR, 1),
	GATE(_CK_TIM13, CK_KER_TIM13, _TIMG1_CK, 0, RCC_TIM13CFGR, 1),
	GATE(_CK_TIM14, CK_KER_TIM14, _TIMG1_CK, 0, RCC_TIM14CFGR, 1),

	GATE(_CK_TIM1, CK_KER_TIM1, _TIMG2_CK, 0, RCC_TIM1CFGR, 1),
	GATE(_CK_TIM8, CK_KER_TIM8, _TIMG2_CK, 0, RCC_TIM8CFGR, 1),
	GATE(_CK_TIM15, CK_KER_TIM15, _TIMG2_CK, 0, RCC_TIM15CFGR, 1),
	GATE(_CK_TIM16, CK_KER_TIM16, _TIMG2_CK, 0, RCC_TIM16CFGR, 1),
	GATE(_CK_TIM17, CK_KER_TIM17, _TIMG2_CK, 0, RCC_TIM17CFGR, 1),
	GATE(_CK_TIM20, CK_KER_TIM20, _TIMG2_CK, 0, RCC_TIM20CFGR, 1),

	GATE(_CK_LPTIM1, CK_KER_LPTIM1, _CK_FLEXGEN_07, 0, RCC_LPTIM1CFGR, 1),
	GATE(_CK_LPTIM2, CK_KER_LPTIM2, _CK_FLEXGEN_07, 0, RCC_LPTIM2CFGR, 1),
	...
	GATE(_CK_SPI2, CK_KER_SPI2, _CK_FLEXGEN_10, 0, RCC_SPI2CFGR, 1),
	GATE(_CK_SPI3, CK_KER_SPI3, _CK_FLEXGEN_10, 0, RCC_SPI3CFGR, 1),
	GATE(_CK_SPDIFRX, CK_KER_SPDIFRX, _CK_FLEXGEN_11, 0, RCC_SPDIFRXCFGR, 1),
	GATE(_CK_I2C1, CK_KER_I2C1, _CK_FLEXGEN_12, 0, RCC_I2C1CFGR, 1),
	GATE(_CK_I2C2, CK_KER_I2C2, _CK_FLEXGEN_12, 0, RCC_I2C2CFGR, 1),
	GATE(_CK_I3C1, CK_KER_I3C1, _CK_FLEXGEN_12, 0, RCC_I3C1CFGR, 1),
	GATE(_CK_I3C2, CK_KER_I3C2, _CK_FLEXGEN_12, 0, RCC_I3C2CFGR, 1),
	GATE(_CK_I2C3, CK_KER_I2C3, _CK_FLEXGEN_13, 0, RCC_I2C3CFGR, 1),
	GATE(_CK_I2C5, CK_KER_I2C5, _CK_FLEXGEN_13, 0, RCC_I2C5CFGR, 1),
	GATE(_CK_I3C3, CK_KER_I3C3, _CK_FLEXGEN_13, 0, RCC_I3C3CFGR, 1),
	...
	GATE(_CK_SPI1, CK_KER_SPI1, _CK_FLEXGEN_16, 0, RCC_SPI1CFGR, 1),
	GATE(_CK_SPI4, CK_KER_SPI4, _CK_FLEXGEN_17, 0, RCC_SPI4CFGR, 1),
	GATE(_CK_SPI5, CK_KER_SPI5, _CK_FLEXGEN_17, 0, RCC_SPI5CFGR, 1),
	GATE(_CK_SPI6, CK_KER_SPI6, _CK_FLEXGEN_18, 0, RCC_SPI6CFGR, 1),
	GATE(_CK_SPI7, CK_KER_SPI7, _CK_FLEXGEN_18, 0, RCC_SPI7CFGR, 1),
	...
	GATE(_CK_MDF1, CK_KER_MDF1, _CK_FLEXGEN_23, 0, RCC_MDF1CFGR, 1),
	GATE(_CK_SAI1, CK_KER_SAI1, _CK_FLEXGEN_23, 0, RCC_SAI1CFGR, 1),
	GATE(_CK_SAI2, CK_KER_SAI2, _CK_FLEXGEN_24, 0, RCC_SAI2CFGR, 1),
	GATE(_CK_SAI3, CK_KER_SAI3, _CK_FLEXGEN_25, 0, RCC_SAI3CFGR, 1),
	GATE(_CK_SAI4, CK_KER_SAI4, _CK_FLEXGEN_25, 0, RCC_SAI4CFGR, 1),
	GATE(_CK_FDCAN, CK_KER_FDCAN, _CK_FLEXGEN_26, 0, RCC_FDCANCFGR, 1),

	/* WARNING 2 CLOCKS FOR ONE GATE */
	GATE(_CK_DSIBLANE, CK_KER_DSIBLANE, _CK_FLEXGEN_27, 0, RCC_DSICFGR, 1),
	GATE(_CK_DSIPHY, CK_KER_DSIPHY, _CK_FLEXGEN_28, 0, RCC_DSICFGR, 1),

	/* WARNING 3 CLOCKS FOR ONE GATE */
	GATE(_CK_CSI2, CK_KER_CSI2, _CK_FLEXGEN_29, 0, RCC_CSI2CFGR, 1),
	GATE(_CK_CSI2TXESC, CK_KER_CSI2TXESC, _CK_FLEXGEN_30, 0, RCC_CSI2CFGR, 1),
	GATE(_CK_CSI2PHY, CK_KER_CSI2PHY, _CK_FLEXGEN_31, 0, RCC_CSI2CFGR, 1),
	GATE(_CK_LVDSPHY, CK_KER_LVDSPHY, _CK_FLEXGEN_32, 0, RCC_LVDSCFGR, 1),
	...
	GATE(_CK_I3C4, CK_KER_I3C4, _CK_FLEXGEN_36, 0, RCC_I3C4CFGR, 1),
	GATE(_CK_SPI8, CK_KER_SPI8, _CK_FLEXGEN_37, 0, RCC_SPI8CFGR, 1),
	GATE(_CK_I2C8, CK_KER_I2C8, _CK_FLEXGEN_38, 0, RCC_I2C8CFGR, 1),
	GATE(_CK_LPUART1, CK_KER_LPUART1, _CK_FLEXGEN_39, 0, RCC_LPUART1CFGR, 1),
	GATE(_CK_LPTIM3, CK_KER_LPTIM3, _CK_FLEXGEN_40, 0, RCC_LPTIM3CFGR, 1),
	GATE(_CK_LPTIM4, CK_KER_LPTIM4, _CK_FLEXGEN_41, 0, RCC_LPTIM4CFGR, 1),
	GATE(_CK_LPTIM5, CK_KER_LPTIM5, _CK_FLEXGEN_41, 0, RCC_LPTIM5CFGR, 1),
	GATE(_CK_MDF2, CK_KER_MDF2, _CK_FLEXGEN_42, 0, RCC_MDF2CFGR, 1),
	GATE(_CK_TSDBG, CK_KER_TSDBG, _CK_FLEXGEN_43, 0, RCC_DBGCFGR, 8),
	GATE(_CK_TPIU, CK_KER_TPIU, _CK_FLEXGEN_44, 0, RCC_DBGCFGR, 9),
	GATE(_CK_ETR, CK_BUS_ETR, _CK_FLEXGEN_45, 0, RCC_ETRCFGR, 1),
	GATE(_CK_ADC12, CK_KER_ADC12, _CK_FLEXGEN_46, 0, RCC_ADC12CFGR, 1),
	GATE(_CK_ADC3, CK_KER_ADC3, _CK_FLEXGEN_47, 0, RCC_ADC3CFGR, 1),
	...
	GATE(_CK_SDMMC3, CK_KER_SDMMC3, _CK_FLEXGEN_53, 0, RCC_SDMMC3CFGR, 1),
	GATE(_CK_ETH1, CK_KER_ETH1, _CK_FLEXGEN_54, 0, RCC_ETH1CFGR, 5),
	GATE(_CK_ETHSW, CK_KER_ETHSW, _CK_FLEXGEN_54, 0, RCC_ETHSWCFGR, 5),
	GATE(_CK_ETH2, CK_KER_ETH2, _CK_FLEXGEN_55, 0, RCC_ETH2CFGR, 5),
	GATE(_CK_ETH1PTP, CK_KER_ETH1PTP, _CK_FLEXGEN_56, 0, RCC_ETH1CFGR, 1),
	GATE(_CK_ETH2PTP, CK_KER_ETH2PTP, _CK_FLEXGEN_56, 0, RCC_ETH2CFGR, 1),
	...
	GATE(_CK_ETHSWREF, CK_KER_ETHSWREF, _CK_FLEXGEN_60, 0, RCC_ETHSWCFGR, 21),
	GATE(_CK_MCO1, CK_MCO1, _CK_FLEXGEN_61, 0, RCC_MCO1CFGR, 8),
	GATE(_CK_MCO2, CK_MCO2, _CK_FLEXGEN_62, 0, RCC_MCO2CFGR, 8),
};
...
uint32_t mp25_clksrc[CLKSRC_NB];
uint32_t mp25_clkdiv[CLKDIV_NB];
...
static void stm32mp2_pll_mux_cfg(unsigned int pll_id, unsigned int pll_src)
{
	...
	mmio_clrsetbits_32(rcc_base + RCC_MUXSELCFGR,
			   RCC_MUXSELCFGR_MUXSEL0_MASK << muxsel_shift,
...
{
	mmio_setbits_32(stm32mp2_pll_cfgr(pll_id, 1), RCC_PLLxCFGR1_PLLEN);
}
				      ...
				      unsigned int prediv, unsigned int findiv)
{
	...
	mmio_clrsetbits_32(rcc_base + RCC_PREDIV0CFGR + (0x4 * channel),
	...
	mmio_clrsetbits_32(rcc_base + RCC_FINDIV0CFGR + (0x4 * channel),
	...
	mmio_clrsetbits_32(rcc_base + RCC_XBAR0CFGR + (0x4 * channel),
			   RCC_XBARxCFGR_XBARxSEL_MASK,
			   clk_src);
	mmio_setbits_32(rcc_base + RCC_XBAR0CFGR + (0x4 * channel),
...
int stm32mp2_clk_stgen_configure(struct stm32_clk_priv *priv, int id)
{
...
struct stm32mp2_clk_platdata stm32mp25_pdata = {
	.osci = mp25_osci,
	.nosci = NB_OSCILLATOR,
	.pll = mp25_pll,
	.npll = _PLL_NB,
...
__attribute__((weak))
struct stm32mp2_clk_platdata *stm32_clk_get_platdata(void)
{
...
int stm32mp2_clk_init(void)
{
	...
	pdata = stm32_clk_get_platdata();

	err = stm32mp2_clk_parse_fdt(pdata);
	if (err != 0) {
		return err;
	}

	priv = stm32_clk_get_driverdata(pdata);
