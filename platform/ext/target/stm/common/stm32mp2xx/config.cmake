...
set(STM32_FWU_STORAGE_ACCESS    OFF                     CACHE BOOL      "Enable firmware update API when TF-M is able to write image in slot (dual storage use case)")
...
if (STM32_M33TDCID)
	...
	set(PLATFORM_DEFAULT_BL2_FWU          OFF                  CACHE BOOL   "Use default platform specific firmware update for BL2")
	...
	set(STM32_CA35_FW_SLOT_SIZE           0x200000             CACHE STRING	"Cortex-A35 Firmware slot size in SDMMC interface boot device")
	...
	set(TFM_FWU_BOOTLOADER_LIB    "${CMAKE_CURRENT_LIST_DIR}/secure_fw/fwu/mcuboot"   CACHE STRING   "Bootloader lib layer configuration files for Firmware Update partition")
