...
void default_ns_exception_handler(void)
{
	while (1) {
	}
}
...
__NO_RETURN __attribute__((naked)) void default_exception_handler(void)
{
	...
	__ASM volatile("BL	default_ns_exception_handler\n"
		       "B	.\n"
	);
}
...
DEFAULT_IRQ_HANDLER(LTDC_IRQ_IRQHandler)
DEFAULT_IRQ_HANDLER(LTDC_ER_IRQ_IRQHandler)
DEFAULT_IRQ_HANDLER(LTDC_SEC_IRQ_IRQHandler)
DEFAULT_IRQ_HANDLER(LTDC_SEC_ER_IRQ_IRQHandler)
...
DEFAULT_IRQ_HANDLER(RNG1_IRQHandler)
DEFAULT_IRQ_HANDLER(HASH2_IRQHandler)
...
DEFAULT_IRQ_HANDLER(OTG_IRQHandler)
DEFAULT_IRQ_HANDLER(RNG2_IRQHandler)
...
DEFAULT_IRQ_HANDLER(HPDMA1Handler)
DEFAULT_IRQ_HANDLER(HPDMA2Handler)
DEFAULT_IRQ_HANDLER(HPDMA3Handler)
DEFAULT_IRQ_HANDLER(DBG_AUTH_HOST_IRQHandler)
DEFAULT_IRQ_HANDLER(DBG_AUTH_ACK_IRQHandler)
DEFAULT_IRQ_HANDLER(RCC_HSI_FMON_IRQHandler)
DEFAULT_IRQ_HANDLER(RCC_MSI_FMON_IRQHandler)
...
const VECTOR_TABLE_Type __VECTOR_TABLE[] __VECTOR_TABLE_ATTRIBUTE = {
	...
	EXTI2_0_IRQHandler,           /* EXTI Line 0 interrupt */
	EXTI2_1_IRQHandler,           /* EXTI Line 1 interrupt */
	EXTI2_2_IRQHandler,           /* EXTI Line 2 interrupt */
	EXTI2_3_IRQHandler,           /* EXTI Line 3 interrupt */
	EXTI2_4_IRQHandler,           /* EXTI Line 4 interrupt */
	EXTI2_5_IRQHandler,           /* EXTI Line 5 interrupt */
	EXTI2_6_IRQHandler,           /* EXTI Line 6 interrupt */
	EXTI2_7_IRQHandler,           /* EXTI Line 7 interrupt */
	EXTI2_8_IRQHandler,           /* EXTI Line 8 interrupt */
	EXTI2_9_IRQHandler,           /* EXTI Line 9 interrupt */
	EXTI2_10_IRQHandler,          /* EXTI Line 10 interrupt */
	EXTI2_11_IRQHandler,          /* EXTI Line 11 interrupt */
	EXTI2_12_IRQHandler,          /* EXTI Line 12 interrupt */
	EXTI2_13_IRQHandler,          /* EXTI Line 13 interrupt */
	EXTI2_14_IRQHandler,          /* EXTI Line 14 interrupt */
	EXTI2_15_IRQHandler,          /* EXTI Line 15 interrupt */
	...
	ETH1_PMT_IRQHandler,         /* ETH1 Wkup interrupt (PMT) */
	ETH1_LPI_IRQHandler,         /* ETH1 LPI interrupt */
	ETH2_SBD_IRQHandler,         /* ETH2 global interrupt */
	ETH2_PMT_IRQHandler,         /* ETH2 Wkup interrupt (PMT) */
	...
	LTDC_IRQ_IRQHandler,         /* LTDC global interrupt */
	LTDC_ER_IRQ_IRQHandler,      /* LTDC global error interrupt */
	LTDC_SEC_IRQ_IRQHandler,     /* LTDC security global interrupt */
	LTDC_SEC_ER_IRQ_IRQHandler,  /* LTDC security global error interrupt */
	...
	USBH_WAKEUP_IRQHandler,      /* USBH Remote Wake up from USB2PHY1 */
	...
	RNG1_IRQHandler,             /* RNG1 interrupt */
	0,
	HASH2_IRQHandler,            /* Hash2 interrupt */
	...
	OTG_IRQHandler,              /* USB2 DR global interrupt */
	RNG2_IRQHandler,             /* RNG2 interrupt */
	0,
	0,
	...
	VDDCPU_VD_IRQHandler,        /* VDDCPU voltage detector */
	VDDCORE_VD_IRQHandler,       /* VDDCORE voltage detector */
	0,
	HPDMA1Handler,               /* HPDMA1 channel 0 to 15 wake up */
	HPDMA2Handler,               /* HPDMA2 channel 0 to 15 wake up */
	HPDMA3Handler,               /* HPDMA3 channel 0 to 15 wake up */
	DBG_AUTH_HOST_IRQHandler,    /* debugger has written DBG_AUTH_HOST register */
	DBG_AUTH_ACK_IRQHandler,     /* debugger has read DBG_AUTH_ACK register */
	RCC_HSI_FMON_IRQHandler,     /* HSI Frequency Monitor */
	RCC_MSI_FMON_IRQHandler,     /* MSI Frequency Monitor */
	0,
	0,
	0,
	0,
