...
/* Secure RSS SHMEM */
#define S_RSS_SHMEM_ADDR		DT_REG_ADDR(DT_NODELABEL(psa_buffer))
#define S_RSS_SHMEM_SIZE		DT_REG_SIZE(DT_NODELABEL(psa_buffer))
/* Non-secure regions */
...
#define STM32MP_DDR_FW_BASE		(S_SRAM2_ALIAS(0x0))
